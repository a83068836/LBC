...
namespace WinAPI
{
    ...
    public struct ProcessInfo
    {
        ...
        public System.Windows.Size wsize;
        public System.Windows.Size csize;
    ...
    public class WindowsAPI
    {
        ...
        [DllImport("gdi32.dll")]
        public static extern bool GetWindowExtEx(IntPtr hdc, ref System.Windows.Size lpSize);
        ...
        [DllImport("gdi32.dll")]
        public static extern bool GetTextExtentPoint32(IntPtr hdc, string lpString, int c, ref System.Windows.Size lpSize);
        ...
        [DllImport("gdi32.dll")]
        public static extern bool ScaleViewportExtEx(IntPtr hdc, int Xnum, int Xdenom, int Ynum, int Ydenom, ref System.Windows.Size lpSize);
        ...
        [DllImport("gdi32.dll")]
        public static extern bool ScaleWindowExtEx(IntPtr hdc, int Xnum, int Xdenom, int Ynum, int Ydenom, ref System.Windows.Size lpSize);
        ...
        public static extern int ScreenToClient(IntPtr hWnd, ref System.Windows.Shapes.Rectangle rect);

        [DllImport("user32.dll", CharSet = CharSet.Auto)]
        public static extern int GetClientRect(IntPtr hwnd, ref System.Windows.Shapes.Rectangle rc);

        [DllImport("user32.dll", CharSet = CharSet.Auto)]
        public static extern int GetWindowRect(IntPtr hwnd, ref System.Windows.Shapes.Rectangle rc);
        ...
        {
            SendMessage(hWnd, (uint)WM_SETTEXT, (int)IntPtr.Zero, lParam);
        }
        /// <summary>
        /// 获取内容
        /// </summary>
        ...
        public static string GetText(IntPtr hWnd)
        {
            ...
            SendMessage(hWnd, CommonConst.WM_GETTEXT, buffer_size, buffer);
        ...
        /// <param name="hWnd">句柄</param>
        /// <returns></returns>
        public static System.Windows.Shapes.Rectangle GetWindowRect(IntPtr hWnd)
        {
            System.Windows.Shapes.Rectangle result = default(System.Windows.Shapes.Rectangle);
        ...
        /// <returns></returns>
        public static System.Windows.Shapes.Rectangle ScreenToClient(IntPtr hWnd, System.Windows.Shapes.Rectangle rect)
        {
            System.Windows.Shapes.Rectangle result = rect;
        ...
        /// <param name="hWnd"></param>
        /// <returns></returns>
        public static System.Windows.Shapes.Rectangle GetClientRect(IntPtr hWnd)
        {
            System.Windows.Shapes.Rectangle result = default(System.Windows.Shapes.Rectangle);
        ...
        /// <param name="text"></param>
        /// <returns></returns>
        public static IntPtr GetWnd(Int32 pID, String className, String text)
        {
            ...
            while (h != IntPtr.Zero)
            {
                ...
                h = GetWindow(h, CommonConst.GW_HWNDNEXT);
            }
        ...
        /// <param name="a"></param>
        /// <param name="b"></param>
        public static void SxBtnHt(IntPtr hwnd, int a, int b)
        {
            int x = a;
            int y = b;
            PostMessage(hwnd, CommonConst.WM_LBUTTONDOWN, 0, x + (y << 16));
            PostMessage(hwnd, CommonConst.WM_LBUTTONUP, 0, x + (y << 16));
            //PostMessage(hwnd, WM_sdf, 0, x + (y << 16));
            //Thread.Sleep(100);
        }
